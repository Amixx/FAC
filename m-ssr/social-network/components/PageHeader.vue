<template>
  <header class="container">
    <nav class="bg-emerald-500 border-gray-200 text-white">
      <div
      ...
      >
        ...
        <div v-if="currentUser" class="hidden md:block md:w-auto w-full">
          <ul
          ...
          >
            <li>
              <NuxtLink class="block md:p-0 px-3 py-2" to="/posts">
                Ziņas
              </NuxtLink>
            </li>
            <li v-if="currentUser">
