 ...
 */
final class Version20240521200148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, youtube_id VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
